...
r2score = reg.score(feature_train, target_train)
print('Rsquared score for training data: {}'.format(r2score))
r2scoretst = reg.score(feature_test, target_test)
print('Rsquared score for testing data: {}'.format(r2scoretst))
